...
class PCN(nn.Module):
    ...
    Attributes:
        ...
        latent_dim: 1024
        grid_size:  4
        num_coarse: num_dense // (grid_size ** 2)
    """

    def __init__(self, num_dense=2048, latent_dim=1024, grid_size=4, device='cpu'):
        ...
        self.folding_seed = torch.cat([a, b], dim=0).view(1, 2, self.grid_size ** 2).to(self.device)  # (1, 2, S)
